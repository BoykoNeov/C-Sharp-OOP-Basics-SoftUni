namespace Forum.App
{
    ...
    internal class MenuController
    {
        ...
        private void OpenCategory()
        {
            ...
            var categoryControler = (CategoryController)this.controllers[(int)MenuState.OpenCategory];
            categoryControler.SetCategory(categoryIndex);
        ...
        private void LogInUser()
        {
            ...
            {
                if (controller is IUserRestrictedController userRestricredController)
                {
                    userRestricredController.UserLogIn();
                }
            }
        }
        ...
        private void LogOutUser()
        {
            foreach (var controller in this.controllers)
            {
                if (controller is IUserRestrictedController userRestricredController)
                {
                    userRestricredController.UserLogOut();
                }
            }
        }
    }
